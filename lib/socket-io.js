...
var url = function (t) {
        var e = index$5(t);
        e.port || (/^(http|ws)$/.test(e.protocol) ? e.port = "80" : /^(http|ws)s$/.test(e.protocol) && (e.port = "443")), e.path = e.path || "/";
...
Engine$1.prototype.connect = function () {
    ...
    debug$2("send message -> ", t), wx.sendSocketMessage({
        data: t
    })
}, Engine$1.subEvents = function () {
    wx.onSocketOpen(function () {
...
Socket$1.prototype.subEvents = function () {
    ...
    debug$3("on open"), "/" != this.nsp && this.packet({
        type: parser.CONNECT
    })
}, Socket$1.prototype.onclose = function (t) {
    debug$3("on close -> ", t), this.connected = !1, this.disconnected = !0, delete this.id, this.emit("disconnect", t)
